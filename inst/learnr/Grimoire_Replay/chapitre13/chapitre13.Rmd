...
[![Alternate Text]({image-url})]({https://youtu.be/zNzZ1PfUDNk} "Link Title")


```{r, message=FALSE, warning=FALSE}
# proxy_url <- "http://proxy-rie.http.insee.fr:8080"
# Sys.setenv(http_proxy = proxy_url, https_proxy = proxy_url)
library(vembedr)
embed_url("https://youtu.be/zNzZ1PfUDNk") 
```
...
![](C:/Users/RXD96P/Videos/4.avi){width="560" height="315"}
