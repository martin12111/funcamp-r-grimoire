...
getwd()
chemin <- paste0(getwd(), "/creer_projet.mp4")
chemin
```

<video width="320" height="240" controls>
  <source src="C:/Users/RXD96P/Documents/GitHub/funcamp-r-grimoire/inst/learnr/Grimoire_Replay/chapitre13/creer_projet.mp4" type="video/mp4">
</video>

![](creer_projet.mp4){width="560" height="315"}
![](/creer_projet.mp4){width="560" height="315"}
![](chemin){width="560" height="315"}
![]("creer_projet.mp4"){width="560" height="315"}
![]("/creer_projet.mp4"){width="560" height="315"}
...
```
.
<!-- ok <iframe width="560" height="315" src="https://youtu.be/zNzZ1PfUDNk" frameborder="0" allowfullscreen></iframe> -->
